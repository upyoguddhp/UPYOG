...
public class CommunityHallBookingQueryBuilder {
	...
	private static final StringBuilder bookingDetailsQuery = new StringBuilder(
			"SELECT ecbd.booking_id, booking_no, payment_date, application_date, tenant_id, community_hall_code, \n"
					...
					+ "ecbd.lastmodifiedby, ecbd.lastmodifiedtime,ecbd.permission_letter_filestore_id,ecbd.additionaldetail as ecbd_additionaldetail , ecbd.payment_receipt_filestore_id,ecbd.applicationstatus, \n" + "	\n"
					+ "appl.applicant_detail_id,appl.additionaldetail as appp_addetail,applicant_name, applicant_email_id, applicant_mobile_no,\n"
					+ "applicant_alternate_mobile_no, account_no, ifsc_code, bank_name, bank_branch_name, \n"
					+ "account_holder_name, \n" + "\n" + "address_id, door_no, house_no, address_line_1, \n"
					+ "landmark, city, city_code, pincode, street_name, addr.additionaldetail as add_additionaldetail,locality, locality_code\n" + "	\n"
