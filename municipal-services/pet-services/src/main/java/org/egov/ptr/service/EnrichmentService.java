...
public class EnrichmentService {
	...
	public String getStatusOrAction(String action, Boolean fetchValue) {
        ...
        map.put(PTRConstants.WORKFLOW_ACTION_RETURN_TO_VERIFIER, PTRConstants.APPLICATION_STATUS_PENDINGFORVERIFICATION);
        map.put(PTRConstants.WORKFLOW_ACTION_PENDING_FOR_MODIFICATION, PTRConstants.APPLICATION_STATUS_PENDINGFORMODIFICATION);
