...
import static org.egov.garbageservice.exception.ErrorConstants.ERR_BUDGET_TYPE_MISMATCHED;
import static org.egov.garbageservice.exception.ErrorConstants.ERR_DUPLICATE_BUDGET;
import static org.egov.garbageservice.exception.ErrorConstants.ERR_DUPLICATE_BUDGET_APPLICATION;
import static org.egov.garbageservice.exception.ErrorConstants.ERR_DUPLICATE_ENTITY;
...
public class GarbageServiceExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static boolean isBadRequestException(String errorCode) {
		List<String> badRequestErrorCodes = Arrays.asList(ERR_ROWMAPPER, ERR_INPUT_VALIDATION,
				ERR_DUPLICATE_BUDGET_APPLICATION, ERR_DUPLICATE_ENTITY, ERR_DUPLICATE_BUDGET,
				ERR_BUDGET_TYPE_MISMATCHED);
