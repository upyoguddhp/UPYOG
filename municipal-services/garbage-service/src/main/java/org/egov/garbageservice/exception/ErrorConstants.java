...
public class ErrorConstants {
	...
	public static final String ERR_DUPLICATE_BUDGET_APPLICATION = "ERR_DUPLICATE_BUDGET_APPLICATION";
	public static final String ERR_DUPLICATE_BUDGET = "ERR_DUPLICATE_BUDGET";
	public static final String ERR_DUPLICATE_BUDGET_APPLICATION_MSG = "Budget Application already exists.";

	public static final String ERR_DUPLICATE_BUDGET_ALLOCATION = "ERR_DUPLICATE_BUDGET_ALLOCATION";
	...
	public static final String ERR_BUDGET_TYPE_MISMATCHED = "ERR_BUDGET_TYPE_MISMATCHED";
	public static final String ERR_BUDGET_TYPE_MISMATCHED_MSG = "Budget Type Mismatched.";
}