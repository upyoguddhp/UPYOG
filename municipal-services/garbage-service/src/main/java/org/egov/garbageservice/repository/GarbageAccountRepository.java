...
public class GarbageAccountRepository {
	...
	private static final String SELECT_QUERY_ACCOUNT = "SELECT acc.* "
			...
			+ ", sub_acc.id as sub_acc_id, sub_acc.uuid as sub_acc_uuid, sub_acc.garbage_id as sub_acc_garbage_id, sub_acc.system_property_id as sub_acc_system_property_id, sub_acc.ddp_verified as sub_acc_ddp_verified, sub_acc.property_id as sub_acc_property_id, sub_acc.type as sub_acc_type "
